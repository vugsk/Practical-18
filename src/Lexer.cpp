...
//     {
//         test_func_command();
//         test_func_number_literal();
//         test_func_operator();
//         test_func_string_leteral();
//     }
//
